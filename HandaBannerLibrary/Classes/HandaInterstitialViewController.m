//
//  HandaInterstitialViewController.m
//  divination
//
...
@interface HandaInterstitialViewController ()

@end

@implementation HandaInterstitialViewController
@synthesize adData;
...
- (void)imageTapped:(UIImageView*)image{
    NSLog(@"imageTapped %@", adData);
    if(adData){
        [self.delegate onClickAD:adData.strAdNo advertiser:adData.strAdvertiser];
        NSLog(@"%@", adData.strInterstitialLandingUrl);
        NSLog(@"%@", adData.strBannerLandingUrl);
