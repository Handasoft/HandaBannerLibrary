...
@implementation HouseBannerView
            ...
            if([adData.strBannerImage compare:@""]){
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    ...
                    if(data != nil){
                        ...
                        [self.delegate onLoadSuccess_House:adData.strAdNo];
                    }else{
                        [self.delegate onLoadFail_House];
                    }
                });
            }else{
                dispatch_async(dispatch_get_main_queue(), ^{
...
- (void)imageTapped:(UIImageView*)image{
    if(adData){
        [self.delegate onClickAD_House:adData.strAdNo];
